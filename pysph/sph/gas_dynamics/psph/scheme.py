...
class PSPHScheme(Scheme):
    def __init__(self, fluids, solids, dim, gamma, kernel_factor, betab=2.0,
        ...
        has_ghosts : bool, optional
            if ghost particles (either mirror or periodic) is used, by default False
        alphamin : float, optional
            :math:`\\alpha_{min}` for artificial viscosity switch, by default 0.02
        alphamax : float, optional
            :math:`\\alpha_{max}` for artificial viscosity switch, by default 2.0
